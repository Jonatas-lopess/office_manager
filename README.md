...
**Inbound Logic (Effect 1):**

- Parses incoming data.
- Traps "presence" messages to update React state.
- Sanitizes inbound Uint8Arrays by deep-cloning their buffers to prevent WebAssembly memory misalignment panics (out of memory, bad parameter).
